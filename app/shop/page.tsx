...
export default function ShopPage() {
  return (
    <div className="min-h-screen bg-silver" id="shop-page">
      {/* Header */}
      <section className="bg-navy text-white py-10 sm:py-14 px-4">
        <div className="max-w-7xl mx-auto text-center">
          <div className="inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-white/10 mb-4">
            <ShoppingBag size={28} className="text-green" />
          </div>
          <h1 className="text-3xl sm:text-4xl font-bold">Shop Peptides</h1>
          <p className="mt-3 text-white/70 max-w-lg mx-auto">Third-party lab tested, 99%+ purity. Research peptides and ancillaries.</p>
        </div>
      </section>
